  ...
  const generateLink = async () => {
    ...
    try {
      const res = await fetch(`/api/profesor/alumnos/${resolvedParams.id}`, {
        ...
        // For active users: always use 'link' mode (no password default option)
        // For pending users: also default to link
    ...
    >
      ...
      <div className="max-w-lg mx-auto">
        ...
        <Card className="p-6 mb-6 shadow-sm space-y-4">
          <h3 className="text-base font-medium text-[var(--color-text-primary)] border-b border-[var(--color-border)] pb-2">
            {ta('info_alumno')}
          </h3>
        ...
        <Card className="p-6 shadow-sm border-orange-100 dark:border-orange-900/30 bg-orange-50/30 dark:bg-orange-950/10 space-y-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              {/* Contextual description based on account state */}
