...
The service is provided by **{{OWNER_NAME}}** (hereinafter, "the Provider").
...
- Use the platform solely for the academic purposes for which it was designed.
- Not attempt to access restricted areas of the system.
- Not post offensive, illegal content or content that violates third-party rights.
- Not perform reverse engineering or attempt to compromise the security of the system.
...
We reserve the right to update these Terms and Conditions at any time. Changes will take effect upon publication on this page. Continued use of the service implies acceptance of the updated terms.

---

## 8. Governing Law

These Terms are governed by the laws of the **Republic of Chile**. Any dispute shall be submitted to the competent courts of the city of **Santiago, Chile**.
