...
- Universidad y año de ingreso (opcional)
...
- **Proveer el servicio:** gestionar horarios, asistencia y comunicación entre alumnos y profesores.
- **Notificaciones:** enviar avisos relacionados con sus clases (confirmaciones, cambios, cancelaciones).
- **Mejora del servicio:** analizar el uso de la plataforma de forma agregada y anónima.
...
- **Ejecución del contrato de servicio:** necesario para proveer la plataforma.
