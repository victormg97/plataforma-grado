...
export function buildAlumnoHorarioDetailHref(horarioId: string, from?: string | null): string {
...
export function buildClaseDetailHref(horarioId: string, rol: 'profesor' | 'admin', from?: string | null): string {
