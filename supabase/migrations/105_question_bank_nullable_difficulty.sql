-- Allow NULL difficulty on questions (means "unrated" / no difficulty assigned yet)
ALTER TABLE qb_questions ALTER COLUMN difficulty DROP NOT NULL;
ALTER TABLE qb_questions ALTER COLUMN difficulty DROP DEFAULT;

-- Update the RPC to support filtering by NULL difficulty (p_difficulty = 'unrated')
-- Changed p_difficulty type from qb_difficulty to TEXT to allow 'unrated' as a filter value
