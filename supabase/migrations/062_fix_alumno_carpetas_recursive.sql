-- ============================================================
-- 061_fix_alumno_carpetas_recursive.sql
-- Fix the alumno branch of get_recursos_for_user so that
-- parent folders are visible even when resources are only
-- inside nested subfolders (not directly in the parent).
-- Also fixes the "sin archivos" message in CarpetaPermisosModal
-- by using a recursive subtree check instead of direct children only.
-- ============================================================
