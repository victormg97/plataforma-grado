...
export interface RecursoCardAction {
  key: string;
  label: string;
...
export function RecursoCardActions({ actions, className }: RecursoCardActionsProps) {
